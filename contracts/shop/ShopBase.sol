...
{
    // USDC token contract
    IERC20 internal usdTokenContract;
    ...
    uint256 internal stoneUsdPrice;
    ...
    event SetUSDTokenContract(address usdTokenContract, uint256 timestamp);
    ...
    event SetStonePrice(uint256 price, uint256 timestamp);
