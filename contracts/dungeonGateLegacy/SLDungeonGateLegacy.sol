...
contract SLDungeonGateLegacy is Gate, UUPSUpgradeable {
    function initialize(
    ...
    function __rewardTokensPerRank_init() private {
        rewardTokensPerRank[RankType.E] = [3, 0, 0, 0, 0, 0, 1]; // 2
        rewardTokensPerRank[RankType.D] = [4, 2, 0, 0, 0, 0, 2]; // 3
        rewardTokensPerRank[RankType.C] = [5, 3, 2, 0, 0, 0, 3]; // 4
        rewardTokensPerRank[RankType.B] = [6, 4, 3, 2, 0, 0, 4]; // 5
        rewardTokensPerRank[RankType.A] = [7, 5, 4, 3, 2, 0, 5]; // 6
        rewardTokensPerRank[RankType.S] = [8, 6, 5, 4, 3, 2, 6]; // 7
    }
