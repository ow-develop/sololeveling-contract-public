...
contract StdAssertionsTest is Test {
    ...
    function testAssertFalse_Key() external {
    ...
    function testAssertFalse_Err_Key() external {
    ...
    function testAssertEq_Bool_Key(bool a) external {
    ...
    function testAssertEq_BoolErr_Key(bool a) external {
    ...
    function testAssertEq_Bytes_Key(bytes calldata a) external {
        t._assertEq(a, a, EXPECT_PASS);
    }
    ...
    function testAssertEq_BytesErr_Key(bytes calldata a) external {
        t._assertEq(a, a, CUSTOM_ERROR, EXPECT_PASS);
    }
    ...
    function testAssertEq_UintArr_Key(uint256 e0, uint256 e1, uint256 e2) public {
    ...
    function testAssertEq_IntArr_Key(int256 e0, int256 e1, int256 e2) public {
    ...
    function testAssertEq_AddressArr_Key(address e0, address e1, address e2) public {
    ...
    function testAssertApproxEqAbs_Uint_Key(uint256 a, uint256 b, uint256 maxDelta) external {
    ...
    function testAssertApproxEqAbs_UintErr_Key(uint256 a, uint256 b, uint256 maxDelta) external {
        vm.assume(stdMath.delta(a, b) <= maxDelta);
    ...
    function testAssertApproxEqAbsDecimal_Uint_Key(uint256 a, uint256 b, uint256 maxDelta, uint256 decimals)
        external
    {
        vm.assume(stdMath.delta(a, b) <= maxDelta);
    ...
    function testAssertApproxEqAbsDecimal_UintErr_Key(uint256 a, uint256 b, uint256 maxDelta, uint256 decimals)
        external
    {
        vm.assume(stdMath.delta(a, b) <= maxDelta);
    ...
    function testAssertApproxEqAbs_Int_Key(int256 a, int256 b, uint256 maxDelta) external {
        vm.assume(stdMath.delta(a, b) <= maxDelta);
    ...
    function testAssertApproxEqAbs_IntErr_Key(int256 a, int256 b, uint256 maxDelta) external {
        vm.assume(stdMath.delta(a, b) <= maxDelta);
    ...
    function testAssertApproxEqAbsDecimal_Int_Key(int256 a, int256 b, uint256 maxDelta, uint256 decimals) external {
        vm.assume(stdMath.delta(a, b) <= maxDelta);
    ...
    function testAssertApproxEqAbsDecimal_IntErr_Key(int256 a, int256 b, uint256 maxDelta, uint256 decimals)
        external
    {
        vm.assume(stdMath.delta(a, b) <= maxDelta);
    ...
    function testAssertApproxEqRel_Uint_Key(uint256 a, uint256 b, uint256 maxPercentDelta) external {
    ...
    function testAssertApproxEqRel_UintErr_Key(uint256 a, uint256 b, uint256 maxPercentDelta) external {
        vm.assume(a < type(uint128).max && b < type(uint128).max && b != 0);
        vm.assume(stdMath.percentDelta(a, b) <= maxPercentDelta);
    ...
    function testAssertApproxEqRelDecimal_Uint_Key(uint256 a, uint256 b, uint256 maxPercentDelta, uint256 decimals)
        external
    {
        vm.assume(a < type(uint128).max && b < type(uint128).max && b != 0);
        vm.assume(stdMath.percentDelta(a, b) <= maxPercentDelta);
    ...
    function testAssertApproxEqRelDecimal_UintErr_Key(uint256 a, uint256 b, uint256 maxPercentDelta, uint256 decimals)
        external
    {
        vm.assume(a < type(uint128).max && b < type(uint128).max && b != 0);
        vm.assume(stdMath.percentDelta(a, b) <= maxPercentDelta);
    ...
    function testAssertApproxEqRel_Int_Key(int128 a, int128 b, uint128 maxPercentDelta) external {
        vm.assume(b != 0);
        vm.assume(stdMath.percentDelta(a, b) <= maxPercentDelta);
    ...
    function testAssertApproxEqRel_IntErr_Key(int128 a, int128 b, uint128 maxPercentDelta) external {
        vm.assume(b != 0);
        vm.assume(stdMath.percentDelta(a, b) <= maxPercentDelta);
    ...
    function testAssertApproxEqRelDecimal_Int_Key(int128 a, int128 b, uint128 maxPercentDelta, uint128 decimals)
        external
    {
        vm.assume(b != 0);
        vm.assume(stdMath.percentDelta(a, b) <= maxPercentDelta);
    ...
    function testAssertApproxEqRelDecimal_IntErr_Key(int128 a, int128 b, uint128 maxPercentDelta, uint128 decimals)
        external
    {
        vm.assume(b != 0);
        vm.assume(stdMath.percentDelta(a, b) <= maxPercentDelta);
    ...
    function testAssertEqCall_Return_Key(
    ...
    function testAssertEqCall_Revert_Key(
        bytes memory callDataA,
        bytes memory callDataB,
    ...
    function testAssertNotEq_Bytes_Key(bytes32 a, bytes32 b) external {
        vm.assume(a != b);
    ...
    function testAssertNotEq_BytesErr_Key(bytes32 a, bytes32 b) external {
        vm.assume(a != b);
